...
$force_install_message = 'Welcome to your Dolibarr install by Patas-Monkey';
...
$force_install_dbserver = 'postgres';
...
$force_install_databasepass = 'rootPASS';
...
$baseModule = 'modSociete,modBanque,modCategorie,modProjet,modECM,modApi,';
$hrmModule = 'modHRM,modExpenseReport,modHoliday,';
$commercialModule = 'modCommande,modContrat,modPropale,modTicket,modFicheinter,modExpedition,';
$productModule = 'modService,modProduct,modStock,modProductBatch,';
$force_install_module = $baseModule.$productModule.$hrmModule.$commercialModule.'modFournisseur,modFacture,modSubtotals';
